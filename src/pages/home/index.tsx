...
import vader from "media/audio/vader.mp3";
...
export function Home() {
  ...
  return (
    <section className={css["home-container"]} id="home-container">
      ...
      <section className={css["buttons-container"]}>
        ...
        <Button
          onMouseEnter={handleMouseEnterInstructions}
          onMouseLeave={handleMouseLeaveInstructions}
      ...
      <div className={css["decoration-container"]}>
        <Sable
          onMouseEnter={handleMouseEnterSaber}
          onMouseLeave={handleMouseLeaveSaber}
          className={atomVolumeVal ? css.sable : ""}
        ></Sable>
        <DeathStar
          onMouseEnter={handleMouseEnterStar}
          onMouseLeave={handleMouseLeaveStar}
          className={atomVolumeVal ? css.deathstar : ""}
        ></DeathStar>
      </div>
    </section>
  );
